...
<body>
	...
	<div class="headerSub">
		<a class="headerSubSpan" style="color: #00ab33">전체 펀딩</a> <a
			class="headerSubSpan">펀딩 후기</a>
	</div>
 ...
 --%>
	...
	<div class="content">
		<div class="contentTitle">
			<h2>
				<div class="contentTitleMain">
					<span class="contentTitleSub1">펀딩 결제 신청하기</span> <br /> <a
						href="javascript:void(0);" onclick="history.back(-1);"
						class="contentTitlePrevBtn"> <span class="contentTitleSub2">[취소]</span>
					</a>
				</div>
			</h2>
		</div>
		...
		<div class="contentCont">
			<div class="contentNoticeWrap">
				...
				<div class="contentEstimatedDateP">
					...
					<div class="contentEstimatedDatePR">
						<span class="contentEstimatedDatePR1"></span> <br />
						<span class="contentEstimatedDatePR2">┕ 결제실패 시 다음날 오전에 1회
							재결제 시도</span>
					</div>
				</div>
			</div>
			...
			<div class="contentProduct">
				<div class="contentProductClick">
					<span class="contentProductClickL">주문 상품</span><span
						class="contentProductClickR">▼</span>
				</div>
				<div class="contentProductForToggle">
					<div class="contentSeller">
						<!--주문 상품 toggle start-->
						<div class="contentSellerDiv">
							<span class="contentSellerSpan"></span><span
								class="contentSellerInfo" style="margin-left: 5px">[판매자
								정보 안내]</span>
						</div>
					</div>
					<div class="contentProductDetail">
						<div class="contentProductDetailMain">
							<div class="contentProductDetailMainL">
								<img class="contentProductDetailMainLImg" width="100"
									height="100">
							</div>
							<div class="contentProductDetailMainR">
								...
								<div style="color: #999999">
									<span
										style="border: 1px solid #999999; padding: 1px; margin: 1px; margin-right: 5px;">옵션</span>리워드:
									<span class="contentProductDetailMainR1RewardProdSpan">[DB]
										상품명</span>
								</div>
								<div style="color: #1088ed;">
									<span class="contentProductDetailMainR1RewardPriceSpan"
										style="color: #1088ed;">[DB] 39,900</span>원
								</div>
							</div>
						</div>
					</div>
					<div style="background: #f0faff; line-height: 2.5;">
						주문 금액 <span class="contentProductDetailTotalAmount"
							style="margin-right: 5px">[DB] 총계</span> 원
					</div>
				</div>
			</div>
			...
			<div class="contentUserInfo">
				<div class="contentUserInfoClick">
					<span class="contentUserInfoClickL">주문자</span><span
						class="contentUserInfoClickR">▼</span>
				</div>
				<div class="contentUserInfoForToggle">
					<div class="contentUserInfoGet">
						<!--배송지 toggle-->
						...
						<div class="contentUserInfoGetAddr">
							배송지 입력<br /> <input type="text" name="zipcode" id="zipcode"
								placeholder="우편번호" readonly> <input type="button"
								value="주소검색" id="zipcodeSearch" onclick="execDaumPostcode()"><br />
			...
			<div class="contentPaymentLast">
				<div class="contentPaymentLastClick">
					<span class="contentPaymentLastClickL">펀딩 결제</span><span
						class="contentPaymentLastClickR">▼</span>
				</div>
			...
			<div class="contentAgree">
				<div class="contentAgreeCheckBoxWrap">
					<input class="contentAgreeCheckBox" type="checkbox">
					<div class="contentAgreeCheckBoxA">
						<a href="javascript:void(0)">펀딩결제 이용안내 동의</a>
					</div>
				</div>
				<div class="contentAgreeInfo">
					<div>
						개인정보 제공 동의: <span class="contentAgreeInfoInnerSpan">[DB]
							판매자</span>
					</div>
			...
			<div class="contentTotalAmount">
				<span class="contentTotalAmount">[DB] 합계</span>원
			</div>
			...
			<div class="contentNoticeSmall">한걸음은 전자결제서비스제공자 및 통신판매중개자이며
				통신판매의 당사자가 아닙니다. 상품, 상품정보 및 거래에 관한 의무와 책임은 판매자에게 있습니다.</div>
		...
		<div class="contentNoticeDelayContentModal">
			<p style="text-align: center; margin-bottom: 0;">
				<span style="font-size: 14pt;"><b><span
						style="font-size: 16pt;">도착예정일 안내</span></b></span>
			</p>
			<p
				style="text-align: left; line-height: 1.5; color: #4D4D4D; font-size: 10pt; padding-bottom: 10px;">
				<br /> 배송 업체 또는 기상/교통상황으로 도착 예정일 보다 배송이 지연될 수 있습니다.
			</p>
			<div class="contentNoticeDelayContentModalExit"
				onClick="close_pop();">
	...
	<div class="contentSellerInfoModal" id="contentSellerInfoModal">
		...
		<div class="contentSellerInfoContentModal">
			<p style="text-align: center; margin-bottom: 0;">
				<span style="font-size: 14pt;"><b><span
						style="font-size: 16pt;">판매자 이메일 주소 안내</span></b></span>
			</p>
			<p
				style="text-align: left; line-height: 1.5; color: #4D4D4D; font-size: 10pt; padding-bottom: 10px;">
				<br /> 이메일:&nbsp;&nbsp;<span
					class="contentSellerInfoContentModalInnerSpan"> [DB] 이메일</span> <br />주문상품
				관련하여 판매자에게 보내야 하는 자료/파일이 있는 경우, 주문자 정보와 요구사항을 포함하여 위 이메일 주소로 보내주세요.
			</p>
	...
	<div class="contentUseAgreeModal" id="contentUseAgreeModal">
		...
		<div class="contentUseAgreeContentModal">
			<p style="text-align: center; margin-bottom: 0;">
				<span style="font-size: 14pt;"><b><span
						style="font-size: 16pt;">펀딩결제 이용 안내</span></b></span>
			</p>
			<p
				style="text-align: left; line-height: 1.5; color: #4D4D4D; font-size: 10pt; padding-bottom: 10px;">
				<br /> 1. 귀하가 해피빈 펀딩에서 신청하신 펀딩결제는 네이버파이낸셜㈜에서 대행합니다. <br />2. 귀하의
				결제수단에서 제공하는 이용내역에는 이용판매처로 네이버파이낸셜㈜가 표기되며, 네이버페이 결제내역에는 펀딩 상품 판매처로 해당
				판매처가 표기됩니다. <br />3. 펀딩 상품 실제 결제일 전 취소 및 저장된 결제수단 삭제는 해피빈 펀딩내역 화면을
				통해 진행하실 수 있습니다. <br />4. 펀딩결제를 통해 귀하가 결제해야 할 금액은 판매처에서 등록한 상품금액을
				기준으로 할인금액을 적용하여 승인되므로, 승인금액에 대한 확인 및 문의는 판매처에 부탁드립니다. <br />5. 펀딩결제시
				귀하가 보유한 네이버페이 포인트 및 네이버페이 머니의 사용 여부는 최초 펀딩결제 신청 시점에 선택할 수 있으며, 해피빈
				펀딩내역 화면의 펀딩 결제수단 관리 메뉴를 통해 상시 변경 가능합니다. <br />네이버페이 머니 통장 서비스 미이용자의
				경우, 네이버페이 포인트 및 네이버페이 머니의 사용을 "ON"으로 설정하면 펀딩결제 시점에 보유한 네이버페이 포인트 및
				네이버페이 머니가 우선 차감되고 차감 후 잔여금액에 대해 결제가 진행됩니다. <br />네이버페이 머니 통장 서비스
				이용자의 경우, 네이버페이 포인트의 사용을 "ON"으로 설정하면 펀딩결제 시점에 보유한 네이버페이 포인트가 우선 차감되고
				차감 후 잔여금액에 대해 결제가 진행됩니다. <br />6. 네이버파이낸셜㈜는 귀하의 본 펀딩결제 신청에 따라 발생하는
				결제내역을 설정하신 알림 수단으로 통보해 드리며, https://new-m.pay.naver.com/pcpay 에서도
				결제내역을 확인하실 수 있습니다.
			</p>
	...
	<div class="contentAgreeInfoSafetyModal"
		id="contentAgreeInfoSafetyModal">

		<!-- Modal content -->
		<div class="contentAgreeInfoSafetyContentModal">
			<p style="text-align: center; margin-bottom: 0;">
				<span style="font-size: 14pt;"><b><span
						style="font-size: 16pt;">구매안전 서비스 안내</span></b></span>
			</p>
			<p
				style="text-align: left; line-height: 1.5; color: #4D4D4D; font-size: 10pt; padding-bottom: 10px;">
				<br /> 네이버파이낸셜(주)의 네이버페이 주문서를 통해 거래하는 모든 판매자는 안전거래를 위해 구매금액, 결제수단에
				관계없이 모든 거래에 대하여 자동적으로 네이버파이낸셜(주)이 제공하는 구매안전서비스(결제대금예치)를 적용하고 있습니다. <br />
				<br />네이버파이낸셜(주)의 전자금융거래법에 따라 금융위원회에 전자금융업자로 등록하였으며 결제대금예치업 등록번호는
				02-006-00056 입니다. <br />
				<br />등록여부는 금융감독원 홈페이지(www.fss.or.kr)의 인허가업무안내 > 등록신고 > 전자금융업등록현황에서
				확인하실 수 있습니다.
			</p>
			<div class="contentAgreeInfoSafetyContentModalExit"
				onClick="close_pop();">
				<span style="font-size: 13pt;"> 닫기 </span>
			</div>
		</div>
