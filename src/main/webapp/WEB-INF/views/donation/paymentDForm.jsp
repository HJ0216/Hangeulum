...
<div class="headerSub">
    <a class="headerSubSpan" style="color: #00ab33; font-weight: 700;">진행중 모금함</a>
    <a class="headerSubSpan">모금 후기</a>
</div>
...
<div class="content">
    <div class="contentTitle">
        <h2>
            <div class="contentTitleMain"><span class="contentTitleMainSpan"></span>
                <br/>
                <span class="contentTitleSubSpan"></span>
            </div>
        </h2>

        <a href="javascript:void(0);" onclick="history.back(-1);" class="contentTitlePrevBtn">
            <img src="/Hangeulum/image/prevBtn.jpg" alt="prevBtn" />
        </a>
    ...
    <div class="contentMainCont">
        ...
        <div class="contentMainContAll">
            <div class="contentMainContTitle">
                <h2>
                    <div class="contentMainContTitleMain"><strong>"기부자님의 소중한 마음으로 놀라운 변화가 일어납니다."</strong>
                        <br/>
                        <span class="contentMainContTitleSub">투명한 기부 후기로 그 변화를 소개하고 보답하겠습니다!</span>
                    </div>
                </h2>    
            </div>
            ...
            <div class="contentMainContPayment">
                <div class="contentMainContPaymentAmt">
                    <div class="contentMainContPaymentAmtDetail">
                        <strong class="contentMainContPaymentAmtTitle">결제 할 금액</strong>
                        <input type="text" value="10,000" id="contentMainContPaymentAmtInput">
                        <span class="contentMainContPaymentAmtWon">원</span>

                        <span class="contentMainContPaymentAmtSort">
							<button class="contentMainContPaymentAmtSortBtn" type="button" data-amount="10,000">1만원</button>
							<button class="contentMainContPaymentAmtSortBtn" type="button" data-amount="20,000">2만원</button>
							<button class="contentMainContPaymentAmtSortBtn" type="button" data-amount="30,000">3만원</button>
                            <!--data-* 전역 특성은 사용자 지정 데이터 특성 클래스 형성
                                formPayment.js에서 data 특성 사용 방법: $(this).data('amount')-->
						</span>
					    
                        <span class="contentMainContPaymentAmtNotice">* 기부를 원하는 금액을 입력한 후 <em>'기부하기'</em> 버튼을 눌러주세요!</span>
                    </div>
                </div>
                ...
                <div class="contentMainContPaymentActTot">
                    ...
                    <div style="font-size: 15px;
                                font-weight: 700;
                                margin-top: 30px;">
                        기부금 영수증 발급 및 각종 후원 관련 문의 : 02-3486-9600
                    </div>
                ...
                <div class="contentMainContPaymentRegular">
                    <div class="contentMainContPaymentRegularInner">
                        <strong class="contentMainContPaymentRegularInner1">결제수수료 없이 100% 기부</strong>
                        <p class="contentMainContPaymentRegularInner2">결제하신 금액은 기부시 별도 수수료 없이 <em>단체로 100% 기부</em>됩니다.</p>
                    </div>
                    
                    <div class="contentMainContPaymentBtn">
                        <a href="javascript:void(0);" class="contentMainContPaymentRegularBtnY">기부하기</a>
                        <a href="javascript:void(0);" onclick="history.back(-1);" class="contentMainContPaymentRegularBtnN">모금함으로 돌아가기</a>
                    </div>
                </div>
