	...
	<div class="content">
		<div class="contentTitle">
			<div class="contentTitleMain">
				<div>
					<a href="/Hangeulum/support/noticeList">공지사항</a>
				</div>
			</div>
		...
		<div class="contentSearch">
			<div class="contentSearchInner">
				...
				<div class="contentSearchContent">
					<input class="contentSearchContent" type="text"
						placeholder="검색어 입력" />
				</div>
				<div class="contentSearchClick">
					<button type="submit" id="contentSearchClickBtn" title="검색">
						<img src="/Hangeulum/image/enlargement.png" alt="enlargement"
							class="contentSearchClickImg">
					</button>
				</div>
			</div>
		</div>
