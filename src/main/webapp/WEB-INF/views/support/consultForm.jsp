...
<body>
	...
	<div class="headerSub">
		...
		<a href="/Hangeulum/support/faqList" class="headerSubSpan">자주 묻는
			질문</a> <a href="/Hangeulum/support/consultForm" class="headerSubSpan"
			style="color: #00ab33; font-weight: 700;">문의/신고</a> <a
			href="/Hangeulum/support/termsUse" class="headerSubSpan">약관</a>
	</div>
	...
	<div class="content">
		<div class="contentTitle">
			<div class="contentTitleMain">
				<div>
					<a href="/Hangeulum/support/consultForm">문의/신고</a>
				</div>
			</div>
		...
		<div class="contentFormQ">
						...
						<tr>
							...
							<td>
								<div id="consultFormSelectBox1">
									<div id="formQcate1" title="항목 선택" message="항목을 선택해 주세요.">
										<!--msg: 의미 X-->
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div id="consultFormSelectBox2">
									<div id="formQcate2" title="세부항목 선택" message="세부항목을 선택해 주세요.">
						...
						<tr>
							...
							<td>
								<div class="consultFormEmail">
									<input type="text" name="formQEmail1" id="formQEmail1"
										title="이메일" message="이메일 주소를 입력해 주세요."> <i
										style="padding-top: 6px;">&nbsp;@&nbsp;</i> <input type="text"
										name="formQEmail2" id="formQEmail2" title="이메일도메인"
										message="이메일 도메인 주소를 입력해 주세요.">

									<div class="consultFormSelectBoxEmail">
										<select name="consultFormCategoryEmail"
											id="consultFormCategoryEmail" title="이메일 도메인"
						...
						<tr>
							...
							<td>
								<div class="consultFormPhone">
									<input type="text" name="formQPhone1" id="formQPhone1"
										title="1번째 전화번호" message="1번째 전화번호를 입력해 주세요."> <i
										style="padding: 6px 20px 0 0;">-</i> <input type="text"
										name="formQPhone2" id="formQPhone2" title="2번째 전화번호"
										message="2번째 전화번호를 입력해 주세요."> <i
										style="padding: 6px 20px 0 0;">-</i> <input type="text"
										name="formQPhone3" id="formQPhone3" title="3번째 전화번호"
										message="3번째 전화번호를 입력해 주세요.">
						...
						<tr>
							...
							<td>
								<div class="consultFormContent">
									<textarea name="formQContent" id="formQContent" title="문의내용"
							...
							<td>
								<div class="consultFormCheckBox">
									<div class="consultFormCheckBoxMain">
										<input type="checkbox" name="consultFormCheckBoxYn"
											id="consultFormCheckBoxYn" title="개인정보 처리방침"
											message="개인정보 처리방침을 선택해 주세요."> <label
											for="consultFormCheckBoxYn">동의</label>
									</div>
									<a href="javascript:void(0);"
										class="consultFormCheckBoxPrivacy">내용보기</a>
									<!--
			...
			<div class="consultFormBtnWrap">
				<a href="javascript:void(0);" onclick="history.back(-1);"
					class="consultFormBtn" id="consultFormBtnCancel">취소하기</a> <a
					href="javascript:void(0);" class="consultFormBtn"
					id="consultFormBtnSubmit">접수하기</a>
			</div>
	...
	<div class="consultFormCheckBoxPrivacyModal"
		id="consultFormCheckBoxPrivacyModal">

		<!-- Modal content -->
		<div class="consultFormCheckBoxPrivacyContent">
			<p style="text-align: center;">
				<span style="font-size: 14pt;"><b><span
						style="font-size: 16pt;">온라인문의 개인정보 수집 및 이용 안내</span></b></span>
			</p>
			<p
				style="text-align: left; line-height: 1.5; color: #4D4D4D; font-size: 10pt;">
				<br /> - 귀하는 온라인 문의를 위한 최소한의 개인정보 수집 및 이용에 동의하지 않을 권리가 있으며, 동의 거부 시
				문의하신 내용에 대한 안내가 제한될 수 있습니다. <br /> - 개인정보는 제공자가 동의한 내용 외의 다른 목적으로
				활용되지 않으며, 문의내용 답변을 위해 이용됩니다.
			</p>
			<p>
				<br />
			</p>
			<div id="consultFormCheckBoxPrivacyContentExit"
				onClick="close_pop();">
