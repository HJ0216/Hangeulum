...
<body>
	...
	<div class="headerSub">
		<a href="/Hangeulum/support/noticeList" class="headerSubSpan"
			style="color: #00ab33; font-weight: 700;">공지사항</a> <a
			href="/Hangeulum/support/faqList" class="headerSubSpan">자주 묻는 질문</a>
	...
	<div class="content">
		<div class="contentTitle">
			<div class="contentTitleMain">
				<div>
					<a href="/Hangeulum/support/noticeList"
		...
		<div class="contentViewWrap">
			<div class="contentView">
				<div class="contentViewTitle">
					<strong> <span id="contentBoardTableLabel1">중요</span> <span
						id="contentViewTitleSpan"></span>
					</strong>
				...
				<div class="contentViewPage" id="contentViewPagePreDiv">
					<span class="contentViewPage" id="contentViewPagePreSpan">
						<div class="contentViewPageInner1">
							<span class="contentViewPageInner11"
								id="contentViewPageInner11PreSpan">이전</span>
						</div>
				...
				<div class="contentViewPage" id="contentViewPageNextDiv">
					<span class="contentViewPage" id="contentViewPageNextSpan">
						<div class="contentViewPageInner1">
							<span class="contentViewPageInner11"
								id="contentViewPageInner11NextSpan">다음</span>
						</div>
				...
				<a href="/Hangeulum/support/noticeList?pg=<%=pg%>"
					class="contentViewListBtn">목록</a>
