...
public class DonationController {
	 ...
	 * 
	 * @ResponseBody public Map<String, Object> totalDonation() { return
	 * donationService.totalDonation(); }
	 */
	...
	@ResponseBody
	public void fun_write(@ModelAttribute BoardDDTO boardDDTO, MultipartFile file, HttpSession session)
			throws Exception {
		...
		// boardDDTO.setBdImg(File.separator + "imgUpload" + ymdPath + File.separator +
		// fileName);
		// boardDDTO.setBdThumbImg(File.separator + "imgUpload" + ymdPath +
